...
export function FeedPostCard({ post, currentUserId }: { post: FeedPost; currentUserId: string | null }) {
    ...
    <div className="card rounded-2xl overflow-hidden">
      ...
      <div className="p-4">
        ...
        <div className="flex gap-4 text-sm text-[var(--chalk-muted)]">
          <LikeButton postId={post.id} initialCount={post.likes_count} currentUserId={currentUserId} />
